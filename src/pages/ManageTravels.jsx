        ...
        <div>
                            ...
                            >
                                ...
                                {t.isOnline && t.location && (
                                    <div style={{
                                        ...
                                        <span>📍 {t.location.latitude?.toFixed(5)}, {t.location.longitude?.toFixed(5)}</span>
            ...
            {editTravel && (
                <div className="modal-overlay" style={{
                    ...
                    <div className="card modal-content" style={{ maxWidth: 500, width: '100%', maxHeight: '90vh', overflowY: 'auto' }}>
            ...
            {confirmDelete && (
                <div className="modal-overlay" style={{
                    ...
                    <div className="card modal-content" style={{ maxWidth: 380, width: '100%', textAlign: 'center' }}>
